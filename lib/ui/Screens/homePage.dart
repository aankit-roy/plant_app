                      ...
                      children: <Widget>[
                        Positioned(
                          top: 10,
                            ...
                            child: Container(
                              ...
                              child: IconButton(
                                onPressed: null,
                                icon: Icon(_palntList[index].isFavourited== true ?
                        ...
                        Positioned(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text(_palntList[index].category,style: const TextStyle(
                                color: Colors.white70,
                                fontSize: 18,

                              ),),
                              Text(_palntList[index].plantName,style: const TextStyle(
                                color: Colors.white70,
                                fontSize: 16,
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text("₹${_palntList[index].price}",style: TextStyle(
                          ...
                          children:<Widget> [
                            ...
                            Positioned(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text(_palntList[index].category,style: TextStyle(
                                    fontWeight: FontWeight.w500
                                  ),),
                                  Text(_palntList[index].plantName,style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
